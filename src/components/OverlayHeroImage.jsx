...
const OverlayHeroImage = ({ exp, profession }) => {
  ...
  return (
    <div className="relative h-fit">
      ...
      <div className="absolute bottom-0 left-1/2 p-2 transform -translate-x-1/2 rounded-lg shadow-lg w-[280px] text-center bg-linear-to-br from-primary via-yellow-500 to-yellow-700">
        <p
          className={clsx(
            "font-bold",
